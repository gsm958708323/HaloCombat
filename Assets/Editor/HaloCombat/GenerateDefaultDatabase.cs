...
namespace Combat.EditorTools
{
    public static class GenerateDefaultDatabase
    {
        ...
        static void Write()
        {
            ...
            fireball.OnHit = new EffectAsset[] { fireballDamage, applyBurn, cueHit };
            ...
            var homingDamage = Make<DamageEffectAsset>("Damage_Homing"); homingDamage.Coeff = 1f; homingDamage.CanCrit = false; homing.OnHit = new EffectAsset[] { homingDamage };
            ...
            database.Timelines = new[] { tlG1, tlG2, tlDodge };
